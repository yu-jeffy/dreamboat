...
func (m *MockRelay) GetBlockReceived(arg0 context.Context, arg1 structs.TraceQuery) ([]structs.BidTraceWithTimestamp, error) {
	m.ctrl.T.Helper()
...
func (m *MockRelay) GetPayloadDelivered(arg0 context.Context, arg1 structs.TraceQuery) ([]structs.BidTraceExtended, error) {
	m.ctrl.T.Helper()
...
func (m *MockRelay) GetValidators(arg0 context.Context) []types.BuilderGetValidatorsResponseEntry {
	m.ctrl.T.Helper()
...
func (m *MockRelay) RegisterValidator(arg0 context.Context, arg1 []types.SignedValidatorRegistration) error {
	m.ctrl.T.Helper()
